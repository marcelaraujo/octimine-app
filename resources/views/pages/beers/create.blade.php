...
@section('content')
    ...
    <form class="form-horizontal" method="POST" action="{{route('beers.store')}}" enctype="application/x-www-form-urlencoded">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="name" name="name" type="text" placeholder="Beer name" class="form-control input-md" value="{{old('name')}}">
            </div>
        </div>
            ...
            <div class="col-md-4">
                <select id="client_id" name="client_id" class="form-control">
                    ...
                    @foreach ($clients as $client)
                        <option value="{{$client->id}}" @if($client->id==old('client_id')) selected @endif>{{$client->full_name}}</option>
                    @endforeach
                </select>
            </div>
        </div>
